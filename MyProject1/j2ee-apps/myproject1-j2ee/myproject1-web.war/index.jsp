...
<head><title>myproject1-web JSP Index Page</title></head>
<body>
<h1>myproject1-web Test JSP Page</h1>
Welcome to the myproject1-web!  
<p>
If you are seeing this page,
it means you have correctly created a new ATG module.  Here is a link back to 
<dsp:a href="hello.jsp">this page</dsp:a>.
<p>
<%
